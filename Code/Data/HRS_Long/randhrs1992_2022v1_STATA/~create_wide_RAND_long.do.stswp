...
* 3. Compute returns for all years (2022, 2020, 2018, ..., 2002)
* 4. Prepare controls and compute asset shares/wealth deciles
* 5. Output final wide-format analysis dataset (_randhrs1992_2022v1_analysis.dta)
*
* USAGE: 
...
* ---------------------------------------------------------------------
* STEP 3: Prep 2022 controls & income, create 2020 wealth deciles
* ---------------------------------------------------------------------
di as txt "===================================================================="
di as txt "STEP 3: Prep controls and income (prep_controls_income_2020.do)"
di as txt "===================================================================="
do "prep_controls_income_2020.do"
di as txt ""

* ---------------------------------------------------------------------
* STEP 4: Compute 2022 returns
* ---------------------------------------------------------------------
di as txt "===================================================================="
di as txt "STEP 4: Computing 2022 returns (compute_tot_ret_2022.do)"
di as txt "===================================================================="
...
di as txt "STEP 4 completed successfully"
di as txt ""

* ---------------------------------------------------------------------
* STEP 5-14: Compute returns for 2020, 2018, ..., 2002 (in reverse order)
* Each step merges flows, computes returns, and prepares prior-wave controls
* ---------------------------------------------------------------------
di as txt "===================================================================="
di as txt "STEP 5: Computing 2020 returns (RAND_2020_merge_and_returns.do)"
di as txt "===================================================================="
...
di as txt "===================================================================="
di as txt "STEP 6: Computing 2018 returns (RAND_2018_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2018_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 7: Computing 2016 returns (RAND_2016_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2016_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 8: Computing 2014 returns (RAND_2014_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2014_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 9: Computing 2012 returns (RAND_2012_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2012_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 10: Computing 2010 returns (RAND_2010_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2010_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 11: Computing 2008 returns (RAND_2008_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2008_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 12: Computing 2006 returns (RAND_2006_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2006_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 13: Computing 2004 returns (RAND_2004_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2004_merge_and_returns.do"
di as txt ""

di as txt "===================================================================="
di as txt "STEP 14: Computing 2002 returns (RAND_2002_merge_and_returns.do)"
di as txt "===================================================================="
do "RAND_2002_merge_and_returns.do"
di as txt ""

* ---------------------------------------------------------------------
* STEP 15: Compute asset shares, liability shares, wealth deciles for all waves
* ---------------------------------------------------------------------
di as txt "===================================================================="
di as txt "STEP 15: Computing asset shares and wealth deciles (prep_controls_ret_panel.do)"
di as txt "===================================================================="
